...
export default function App() {
  ...
  // Bank config adjustable by admin
  ...
  const handleRipOpen = () => {
    ...
    if (availableAccs.length === 0) {
      alert("Kho Nick hien tai dang het! Vui long lien he Admin nap them.");
      return;
    }
  ...
  const handleTopup = (e: React.FormEvent) => {
    ...
    alert("Da nhan lenh nap " + val.toLocaleString("vi-VN") + " VND thanh cong!");
    setTopupAmount("");
    setActiveTab("home");
  };
        ...
        {activeTab === "admin" && role === "admin" && (
          <div style={{ backgroundColor: "#151921", padding: "24px", borderRadius: "12px" }}>
            ...
            <div style={{ margin: "20px 0", padding: "16px", backgroundColor: "#0f131c", borderRadius: "8px" }}>
              <h3 style={{ color: "#eab308" }}>1. Cai Dat Ngan Hang (Trang Nap)</h3>
            ...
            <div style={{ margin: "20px 0", padding: "16px", backgroundColor: "#0f131c", borderRadius: "8px" }}>
              <h3 style={{ color: "#eab308" }}>2. Cong / Tru So Du User Hien Tai</h3>
            ...
            <div style={{ margin: "20px 0", padding: "16px", backgroundColor: "#0f131c", borderRadius: "8px" }}>
              <h3 style={{ color: "#eab308" }}>3. Them Acc Moi Vao Kho Server</h3>
